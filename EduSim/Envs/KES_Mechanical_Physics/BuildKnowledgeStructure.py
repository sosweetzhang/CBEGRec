...
# create a new class BuildKG_LLM
class BuildKG_LLM:
    def __init__(self, model_name):
        self.model_name = model_name

    # generate the knowledge structure using the given concepts
    def KG_generation(self, concepts):
        """
        Use a large language model to generate a knowledge structure based on the given concepts.
        :param concepts:
        :return:
        """

        # Prepare the prompt for the large language model (LLM)
        prompt = f"""
