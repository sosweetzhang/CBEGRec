"""Train E-CGE on 50% data (recommender state estimate). 50% subset of 80%. Saves to models/{domain}/ecge_50/."""
import sys
...
class ECGE50Trainer:
    """Train E-CGE (50% data) for recommender."""
    DATA_SPLIT_SEED = 42
    ...
    def _load_data(self):
        """Load data and sample 50% (subset of 80%)."""
